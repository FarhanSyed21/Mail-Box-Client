...
import { useRef } from 'react';
  ...
  const ComposeMail = () => {
    ...
    const handleSendEmail = async (e) => {
      ...
      try{
        const response1 = await fetch(`https://api-calls-70500-default-rtdb.firebaseio.com/mails/${replaceEmail}/sentEmails.json`,{
          method: "POST",
        ...
        const response2 = await fetch(`https://api-calls-70500-default-rtdb.firebaseio.com/mails/${ToEmail}/inboxEmails.json`,{
          method: "POST",
          body: JSON.stringify(emailDetails),
          headers: {
            "Content-Type": "application/json"
